...
public class GLPixelFunctionsErrorCheck implements IGLPixelFunctions {

	private final	IGLPixelFunctions	pixelFunctions;
	private			GLErrorChecker		errorChecker;

	public GLPixelFunctionsErrorCheck(IGLPixelFunctions pixelFunctions) {
	...
	public void pixelStore(int pixelParameter, int value) {
		errorChecker.runChecked("pixelStore", () -> pixelFunctions.pixelStore(pixelParameter, value));
	}
}
