...
public enum GLDepthStencilTextureMode {

	INVALID			(-1),
	DEPTH_COMPONENT	(GL11.GL_DEPTH_COMPONENT),
	STENCIL_INDEX	(GL11.GL_STENCIL_INDEX);

	private static final Int2ReferenceMap<GLDepthStencilTextureMode> TABLE;

	static {
		TABLE = new Int2ReferenceOpenHashMap<>();

		for (var mode : GLDepthStencilTextureMode.values()) {
	...
	GLDepthStencilTextureMode(int constant) {
	...
	public static GLDepthStencilTextureMode fromConstant(int constant) {
