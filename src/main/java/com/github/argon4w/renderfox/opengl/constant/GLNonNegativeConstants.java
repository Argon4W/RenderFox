...
public class GLNonNegativeConstants<T> extends AbstractGLDefinedConstants<T> {

	public static final GLNonNegativeConstants<?> INSTANCE = new GLNonNegativeConstants<>();
