...
public class GLQueryConstantsFloat extends AbstractGLDefinedConstants<IGLGlobalFunctionsHelper> {

	private final GLGlobalParameter	parameter;
	private final float				minValue;

	public GLQueryConstantsFloat(GLGlobalParameter parameter, float minValue) {
	...
	public boolean isValidValue(IGLGlobalFunctionsHelper context, UnionValue value) {
		return value.asFloat() >= minValue && value.asFloat() <= context.getFloat(parameter);
	}
}
