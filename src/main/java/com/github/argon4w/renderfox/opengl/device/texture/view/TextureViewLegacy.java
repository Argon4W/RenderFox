...
package com.github.argon4w.renderfox.opengl.device.texture.view;
...
import com.github.argon4w.renderfox.opengl.texture.object.raw.GLRawTextureViewLegacy;
import com.github.argon4w.renderfox.opengl.texture.object.raw.IGLRawTextureView;

public class TextureViewLegacy implements ITextureView {

	private final GLTextureContext textureContext;

	public TextureViewLegacy(GLTextureContext textureContext) {
		this.textureContext = textureContext;
	}

	@Override
	public IGLRawTextureView createRawView(
		...
		return new GLRawTextureViewLegacy(
				texture,
				textureContext,
				viewSwizzleRed,
				viewSwizzleGreen,
